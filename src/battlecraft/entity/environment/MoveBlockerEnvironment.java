...
public class MoveBlockerEnvironment implements Drawable, MoveBlocker, GameEntity {
	protected DrawableImage image;
	protected Point position;
	public int RENDERING_SIZE = 32;
	public Rectangle BOUNDING_BOX;

	public MoveBlockerEnvironment(Canvas defaultCanvas, Point position, String spritePath, Rectangle BOUNDING_BOX) {
